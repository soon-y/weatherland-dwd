export default function Box({ style, children, setDisplay, title, setBoxClicked, className }) {
  ...
  return (
    <div className={`${className} z-10 bg-white/20 rounded-xl px-3 py-2 sm:px-4 sm:py-3 select-none duration-500 hover:outline-1 hover:outline-white/50 transition-all
